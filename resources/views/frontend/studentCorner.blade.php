        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="found-jobs-count-wrap e-learning-top d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <form class="find-a-jobs-wrap" action="{{ route('student.corner') }}" method="GET">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-12 order-2 order-md-1">
                    <div class="row">
                        @foreach($studentCorner as $studentCornerData)
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="learning-card h-100 d-flex flex-column">
                                    <div class="learning-card-image">
                                        <a href="{{ route('student.corner.details', $studentCornerData->id) }}">
                                            <img src="{{ asset('images/studentCorner/' . $studentCornerData->image) }}" alt="">
                                        </a>
                                    </div>
                                    <div class="learning-card-content flex-grow-1">
                                        <div class="top">
                                            <a href="{{ route('student.corner.details', $studentCornerData->id) }}">
                                                <h3>{{ $studentCornerData->title }}</h3>
                                            </a>
                                            <div class="deadline d-flex align-items-center">
                                                <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M16 18H2V7H16V18ZM13 0V2H5V0H3V2H2C0.89 2 0 2.89 0 4V18C0 18.5304 0.210714 19.0391 0.585786 19.4142C0.960859 19.7893 1.46957 20 2 20H16C16.5304 20 17.0391 19.7893 17.4142 19.4142C17.7893 19.0391 18 18.5304 18 18V4C18 2.89 17.1 2 16 2H15V0H13ZM14 11H9V16H14V11Z" fill="currentColor"/>
                                                </svg>
                                                {{ \Carbon\Carbon::parse($studentCornerData->date)->format('d M Y') }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="register-now mt-auto">
                                        <a href="{{ route('student.corner.details', $studentCornerData->id) }}">Details....</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="category_wrap section-heading">
                        ...
                        <ul>
                            ...
                            @foreach($categories as $category)
                                <li>
                                    <a href="{{ route('student.corner', ['category_id' => $category->id]) }}"
            ...
            <div class="pagination-wrapper">
                {{ $studentCorner->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
@endsection
