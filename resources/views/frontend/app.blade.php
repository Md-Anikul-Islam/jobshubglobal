...
<html lang="en">
@php
    use App\Models\Help;$siteSetting = DB::table('site_settings')->first();
@endphp
<head>
...
<footer class="footer-area">
    <div class="container">
            ...
            >
                ...
                <div class="help-link">
                    ...
                    <ul>
                        ...
                        @php
                            $helpPages = Help::select('name', 'slug')->get();
                        @endphp

                        @foreach($helpPages as $page)
                            <li>
                                <a href="{{ route('help.page', $page->slug) }}">
                                    {{ $page->name }}
                                </a>
                            </li>
                        @endforeach
        ...
        <div class="text-center my-4">
            <img
                src="{{ asset('frontend/images/pament.png') }}"
                alt="Payment Methods"
            ...
            <div class="col-12">
                <div class="copyright-text">
                    <p>
                        ...
                        , JobHubGlobal, All Rights Reserved, লাইসে নং : TRAD/DNCC/006243/2025
                    </p>
                </div>
            </div>
        </div>
