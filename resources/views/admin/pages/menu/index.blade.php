                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    @can('menu-delete')
                                        <a href="{{route('menu.destroy',$menuData->id)}}"class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#danger-header-modal{{$menuData->id}}">Delete</a>
                                    @endcan
                                </div>
                            </td>
                            <!--Edit Modal -->
                                ...
                                <div class="modal-dialog  modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('menu.update',$menuData->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="name" name="name" value="{{$menuData->name}}"
                            ...
                            <!-- Delete Modal -->
                            <div id="danger-header-modal{{$menuData->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="danger-header-modalLabel{{$menuData->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header modal-colored-header bg-danger">
                                            <h4 class="modal-title" id="danger-header-modalLabe{{$menuData->id}}l">Delete</h4>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('menu.destroy',$menuData->id)}}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
