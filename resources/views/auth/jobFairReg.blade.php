...
<head>
    <meta charset="utf-8" />
    <title>Job Fair Register | Job Hub Global</title>
                ...
                <div class="card overflow-hidden">
                    <div class="row g-0 align-items-center">
                        <div class="col-lg-6 d-none d-lg-block p-2">
                            <img src="{{ asset('backend/images/110.png') }}" alt="" class="img-fluid rounded h-200">
                        </div>
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="p-4 pt-0 my-auto">
                                    <h4 class="fs-20">Join Fair</h4>
                                    <p class="text-muted mb-3">Join Job Hub Global.
                                    </p>
                                    <form method="post" action="{{route('job.fair.store')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label  class="form-label">Fair Type</label>
                                            <select name="fair_type" class="form-select">
                                                <option selected>Join Us our Job Fair As Select</option>
                                                <option value="Jobs Fair">Jobs Fair</option>
                                                <option value="Student Fair">Student Fair</option>
                                                <option value="Migration Fair">Migration Fair</option>
                                        ...
                                        <div class="mb-0 text-start">
                                            <button class="btn btn-soft-primary w-100" type="submit"><i class="ri-login-circle-fill me-1"></i> <span class="fw-bold">Join Job Fair</span> </button>
                                        </div>
